...
## [0.8.0](https://github.com/dacrypt/xiao/compare/v0.7.1...v0.8.0) (2026-05-14)
...
* **dashboard:** relabel vacuum-extend diagnostics ([b7b9673](https://github.com/dacrypt/xiao/commit/b7b96739d8a25a2629535225d2ad5282724703db))
* **dashboard:** relabel vacuum-extend diagnostics ([dfb842e](https://github.com/dacrypt/xiao/commit/dfb842eae148165d7f3ce36dff5bcf5dc3ac5b4f))
...
* **dashboard:** relabel the known X20+ `vacuum-extend` diagnostics tiles in Mission Control so `siid 4` raw properties no longer appear as generic `Unknown` slots
