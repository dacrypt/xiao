...
- 🔜 Next planned item: Clean rags tip interval — expose `siid 4 piid 16` (`clean-rags-tip`, 0-120 minutes) as a validated base-station maintenance setting once we lock down the safest CLI shape and value validation. (Planned 2026-04-26)
