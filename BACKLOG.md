...
- 🔜 Next planned item: Smart wash switch toggle — expose `siid 4 piid 34` (`smart-wash-switch`) as another low-risk cloud-backed setting so base-station mop maintenance can be managed alongside the new vacuum-extend toggles. (Planned 2026-04-25)
