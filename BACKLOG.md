...
- 🔜 Next planned item: Carpet avoidance mode — expose `siid 4 piid 36` (`carpet-escape`) as a validated enum setting once we confirm the safest CLI wording for its observed `Escape` vs `Auto` values across Xiaomi/OpenHAB references. (Planned 2026-04-27)
